...
export default function Hero() {
  return (
    <section className="relative h-[500px] overflow-hidden bg-[#111111] md:h-[640px]">
      <img src="/hero_collage_01.jpg" alt="K-fashion editorial" className="absolute inset-0 !h-full !w-full max-w-none object-cover object-center" />
      ...
      <div className="absolute bottom-10 left-5 z-20 max-w-[560px] text-white md:bottom-16 md:left-10">
        ...
        <div className="flex gap-3">
          <Link href="/main-product" className="inline-flex items-center gap-2 rounded-full bg-white px-5 py-2.5 text-xs font-medium text-[#111111]" style={{ color: '#111111' }}>
            <span style={{ color: '#111111' }}>Shop Now</span> <ArrowRight size={14} color="#111111" />
          </Link>
