    ...
    <section id="categories" className="bg-white px-3 pb-20 md:px-4">
      ...
      <div className="grid grid-cols-2 gap-2 sm:gap-4 md:grid-cols-2">
        {categories.map(category => (
          <article key={category.name} className="group relative aspect-[4/5] min-h-[180px] overflow-hidden rounded-lg bg-[#eeeeee] sm:aspect-[16/10] sm:min-h-[230px] sm:rounded-none md:min-h-[280px]">
            ...
            <div className="absolute inset-x-0 bottom-0 px-3 pb-4 pt-12 text-center text-white sm:px-5 sm:pb-6 sm:pt-16">
