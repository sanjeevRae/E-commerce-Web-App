    ...
    <section className="relative h-[500px] overflow-hidden bg-[#111111] md:h-[640px]">
      ...
      <div className="absolute bottom-10 left-5 max-w-[560px] text-white md:bottom-16 md:left-10">
        ...
        <div className="flex gap-3">
          <Link href="/main-product" className="inline-flex items-center gap-2 rounded-full bg-white px-5 py-2.5 text-xs font-medium !text-black">
            <span className="!text-black">Shop Now</span> <ArrowRight size={14} className="!text-black" />
          </Link>
