      ...
      <header className={`z-40 bg-white/95 backdrop-blur ${isHome ? '' : ''} border-b border-[#ececec]`}>
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            <button
              onClick={openSearch}
              className="hidden items-center gap-2.5 p-1 text-sm font-medium text-[#111111] md:inline-flex"
            >
            ...
            <button
              ...
              className="hidden items-center gap-2.5 p-1 text-sm font-medium text-[#111111] md:flex"
              aria-label="Cart"
            >
              <ShoppingCart size={17} strokeWidth={1.8} />
              <span>({totalItems})</span>
            </button>
            <button className="hidden items-center gap-2.5 p-1 text-sm font-medium text-[#111111] md:flex">
